...
display(plot(["E6", "E6.5", "E7", "E7.5" ], [sredundancy, sunique_2, ssynergy, sunique_1], xlabel = "TimePoint", label = ["Redundancy" "Unique for T + Sox2" "Synergy" "Unique for Nanog + Sox2"], title = "Sox2 as target, mode=bayesian_blocks"))
...
display(plot(["E6", "E6.5", "E7", "E7.5" ], [nredundancy, nunique_2, nsynergy, nunique_1], xlabel = "TimePoint", label = ["Redundancy" "Unique for T + Nanog" "Synergy" "Unique for Sox2 + Nanog"], title = "Nanog as target, mode=bayesian_blocks"))
...
display(plot(["E6", "E6.5", "E7", "E7.5" ], [tredundancy, tunique_2, tsynergy, tunique_1], xlabel = "TimePoint", label = ["Redundancy" "Unique for Sox2 + T" "Synergy" "Unique for Nanog + T"], title = "T as target, mode=bayesian_blocks"))