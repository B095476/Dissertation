...
using ExcelReaders
t_e55_file = readxl("C:\\Users\\Carol Clark\\OneDrive\\Dissertation\\Data\\test.xlsx", "T!A2:A5") #read data from file
...
# t_e75_file = readxl("C:\\Users\\Carol Clark\\OneDrive\\Dissertation\\Data\\test.xlsx", "T!A1:A42") #read data from file

# convert to array of Float64
t_e55 = convert.(Float64, t_e55_file) #convert from array of any to array of Float64 and store as new variable
...
ent_t_e55 = get_entropy(t_e55) #calculate entropy 
...
# print entropy 
println("entropy T e5.5 is ", ent_t_e55) #print entropy
...
# display histogram 
using Plots
display(histogram(t_e55)) #plot hisogram of data 
